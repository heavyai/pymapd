            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i74 in range(_size70):
                        _elem75 = TGpuSpecification()
                        _elem75.read(iprot)
                        self.gpu_info.append(_elem75)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TClusterHardwareInfo(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i81 in range(_size77):
                        _elem82 = THardwareInfo()
                        _elem82.read(iprot)
                        self.hardware_info.append(_elem82)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.hardware_info is not None:
            ...
            for iter83 in self.hardware_info:
                iter83.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TNodeMemoryInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i95 in range(_size91):
                        _elem96 = TMemoryData()
                        _elem96.read(iprot)
                        self.node_memory_data.append(_elem96)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.node_memory_data is not None:
            ...
            for iter97 in self.node_memory_data:
                iter97.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TDBObject(object):
    ...
    def write(self, oprot):
        ...
        if self.privs is not None:
            ...
            for iter162 in self.privs:
                oprot.writeBool(iter162)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
