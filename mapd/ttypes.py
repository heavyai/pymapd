...
class TNodeMemoryInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i102 in range(_size98):
                        _elem103 = TMemoryData()
                        _elem103.read(iprot)
                        self.node_memory_data.append(_elem103)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.node_memory_data is not None:
            ...
            for iter104 in self.node_memory_data:
                iter104.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i109 in range(_size105):
                        _elem110 = TColumnType()
                        _elem110.read(iprot)
                        self.row_desc.append(_elem110)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class TPendingQuery(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i116 in range(_size112):
                        _elem117 = TColumnRange()
                        _elem117.read(iprot)
                        self.column_ranges.append(_elem117)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i122 in range(_size118):
                        _elem123 = TDictionaryGeneration()
                        _elem123.read(iprot)
                        self.dictionary_generations.append(_elem123)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i128 in range(_size124):
                        _elem129 = TTableGeneration()
                        _elem129.read(iprot)
                        self.table_generations.append(_elem129)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_ranges is not None:
            ...
            for iter130 in self.column_ranges:
                iter130.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dictionary_generations is not None:
            ...
            for iter131 in self.dictionary_generations:
                iter131.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.table_generations is not None:
            ...
            for iter132 in self.table_generations:
                iter132.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TDataBlockPtr(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i137 in range(_size133):
                        _elem138 = TVarLen()
                        _elem138.read(iprot)
                        self.var_len_data.append(_elem138)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.var_len_data is not None:
            ...
            for iter139 in self.var_len_data:
                iter139.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TInsertData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i144 in range(_size140):
                        ...
                        self.column_ids.append(_elem145)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i150 in range(_size146):
                        _elem151 = TDataBlockPtr()
                        _elem151.read(iprot)
                        self.data.append(_elem151)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.column_ids is not None:
            ...
            for iter152 in self.column_ids:
...
class TRawPixelDataResult(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i158 in range(_size154):
                        ...
                        _val160 = TRawRenderPassDataResult()
                        _val160.read(iprot)
                        self.render_pass_map[_key159] = _val160
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.render_pass_map is not None:
            ...
            for kiter161, viter162 in self.render_pass_map.items():
                oprot.writeI32(kiter161)
                viter162.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.execution_time_ms is not None:
