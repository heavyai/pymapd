...
class TestIntegration:
    ...
    def test_connect_uri(self):
        uri = (
            "omnisci://admin:HyperInteractive@localhost:6274/omnisci?" "protocol=binary"
        )
        con = connect(uri=uri)
    ...
    def test_select_parametrized(self, con):
        ...
        c.execute(
            "select symbol, qty from stocks where symbol = :symbol", {"symbol": "GOOG"}
        )
        result = list(c)
    ...
    def test_select_dates(self, con):
        ...
        c.execute(
            "create table dates (date_ DATE, datetime_ TIMESTAMP, " "time_ TIME);"
        )
        i1 = (
    ...
    def test_dashboard_duplication_remap(self, con):
        ...
        try:
            dashboard_id = con._client.create_dashboard(
                ...
                dashboard_state=(
                    base64.b64encode(json.dumps(old_dashboard_state).encode("utf-8"))
                ),
                image_hash="",
        ...
        remapped_dashboard = json.loads(base64.b64decode(d.dashboard_state).decode())
...
class TestOptionalImports:
    def test_select_gpu(self, con):
        with mock.patch.dict("sys.modules", {"cudf": None, "cudf.dataframe": None}):
...
class TestLoaders:
        ...
        data = pd.DataFrame(
            {
                ...
                "timestamp_": [
                    pd.Timestamp("2016"),
                    pd.Timestamp("2017"),
                    pd.Timestamp("2017-11-28 23:55:59.342380", tz="US/Eastern"),
                    pd.Timestamp("2018-11-28 23:55:59.342380", tz="Asia/Calcutta"),
                ],
                "date_": [
    ...
    def test_load_table_columnar_arrow_all(self, con):
        ...
        columns = [
            ...
            pa.array([datetime.date(2016, 1, 1), datetime.date(2017, 1, 1), None]),
        ]
    ...
    def test_array_in_result_set(self, con):
        ...
        row = [("row1", "{hello,goodbye,aloha}"), ("row2", "{hello2,goodbye2,aloha2}")]
        ...
        row = [
            ...
            ("row2", "{2019-03-02 00:00:00,2019-03-02 00:00:00,2019-03-02 00:00:00}"),
        ]  # noqa
        ...
        expected = [
            (
                "row1",
                [datetime.time(23, 59), datetime.time(23, 59), datetime.time(23, 59)],
            ),
            (
                "row2",
                [datetime.time(23, 59), datetime.time(23, 59), datetime.time(23, 59)],
